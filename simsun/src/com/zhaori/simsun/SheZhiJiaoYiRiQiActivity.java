...
public class SheZhiJiaoYiRiQiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.shezhijiaoyiriqi);
		
		dp = (DatePicker) this.findViewById(R.id.date_picker);
